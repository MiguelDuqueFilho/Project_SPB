...
-- AddForeignKey
ALTER TABLE "catMensagemDados" ADD CONSTRAINT "catMensagemDados_CodMsg_fkey" FOREIGN KEY ("CodMsg") REFERENCES "CatMensagens"("CodMsg") ON DELETE RESTRICT ON UPDATE RESTRICT;
